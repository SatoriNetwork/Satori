defmodule GraphqlPubsubWeb.AuthToken do
  ...
  """
  def sign(user) do
    Phoenix.Token.sign(GraphqlPubsubWeb.Endpoint, @user_salt, %{id: user.id})
  end
  ...
  """
  def verify(token) do
    Phoenix.Token.verify(GraphqlPubsubWeb.Endpoint, @user_salt, token, [
      max_age: 365 * 24 * 3600
    ])
  end
end
